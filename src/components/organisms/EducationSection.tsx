    ...
    >
      <div className="w-full mx-auto space-y-6 md:space-y-20">
        ...
        <div className="relative min-h-[400px]">
          ...
          >
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-8 h-8 bg-brand-yellow border-4 border-brand-black rounded-full" />
            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-8 h-8 bg-brand-yellow border-4 border-brand-black rounded-full" />
          </motion.div>
              ...
              >
                <motion.div
                  className="absolute
                      ...
                      bg-brand-yellow rounded-full border-4 border-brand-black z-10 transition-transform duration-300 group-hover:scale-125"
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                  transition={{
                    type: "spring",
                ...
                >
                  ...
                  <span className="font-dm font-bold text-brand-yellow/90 text-sm md:text-base lg:text-lg uppercase tracking-widest">
