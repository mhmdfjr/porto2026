        ...
        <div className="relative min-h-[400px]">
          {loading ? (
            ...
            <>
              ...
              {/* Desktop: Horizontal Line Animation - Grow from Left */}
              <motion.div
              ...
              {/* Mobile: Vertical Line Animation - Grow from Top (Right Side) */}
              <motion.div
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 relative z-10">
                {organizations.map((item, index) => (
                  <motion.div
                    ...
                    // Container Animation - Staggered Fade Up
                    initial={{ opacity: 0, y: 50 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{
                      duration: 0.6,
                      delay: index * 0.2, // Delay bertingkat
                      ease: "easeOut",
                    }}
